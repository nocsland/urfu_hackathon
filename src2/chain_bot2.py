...
Все ответы давай в привязке к процессам, регламентам и документам компании ПЭК
...
if __name__ == "__main__":
    # Диалог с помощником
    print("Привет! Я помощник по базе знаний компании ПЭК. Введите ваш вопрос")
    # print("Для завершения диалога напишите 'выход'.")
    while True:
        # Получаем вопрос от пользователя
        question = input("Ваш вопрос: ")

        # Если пользователь ввел "выход", то завершаем диалог
