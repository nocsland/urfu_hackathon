...
документов информацию и предоставляй ее пользователю в виде пошаговой инструкции. Если упоминаешь документ напиши его название и 
его основные тезисы. Не делай повторов предложений. Отвечай на вопрос подробно. Отвечай так, чтобы пользователь мог самостоятельно решить свой вопрос, используя, 
приложение, документацию или сайт компании, без обращений в техническую поддержку или другие службы компании.
'''
...
llm = LlamaCpp(
    ...
    max_length=2000,  # Максимальная длина текста (в символах)
    top_p=0.95,
    top_k=40,
